...
export class Forex implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.renderer.addClass(document.body, "siderbar-collapsed");
  ...
  bindTable1(): void {
    ...
    const ratesUrl = "https://openexchangerates.org/api/latest.json?app_id=978e0816097942abb0d98bb63e94bc51";
